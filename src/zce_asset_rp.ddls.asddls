@EndUserText.label: 'Custom Entity - TSCĐ'
@ObjectModel.query.implementedBy: 'ABAP:ZCL_CE_ASSET_RP'
@Metadata.allowExtensions: true
define custom entity zce_asset_rp
{
  ...
  key ThuTu              : abap.int4;
      ...
      @Semantics.amount.currencyCode: 'DisplayCurrency'
      TangNguyenGia      : abap.curr(23,2);
      @Semantics.amount.currencyCode: 'DisplayCurrency'
      GiamNguyenGia      : abap.curr(23,2);
      @Semantics.amount.currencyCode: 'DisplayCurrency'
      NguyenGiaCuoiKy    : abap.curr(23,2);
      @Semantics.amount.currencyCode: 'DisplayCurrency'
      KhauHaoDauKy       : abap.curr(23,2);
      @Semantics.amount.currencyCode: 'DisplayCurrency'
      TangKhauHao        : abap.curr(23,2);
      @Semantics.amount.currencyCode: 'DisplayCurrency'
      GiamKhauHao        : abap.curr(23,2);
      @Semantics.amount.currencyCode: 'DisplayCurrency'
      KhauHaoCuoiKy      : abap.curr(23,2);
      @Semantics.amount.currencyCode: 'DisplayCurrency'
